...
variable "PKG_PLATFORMS_BASE" {
  ...
  default = {
    ...
    # Linux/Windows archives include Engine, CLI, and runtimes; Darwin archives are CLI-only.
    docker = ["darwin/amd64", "darwin/arm64", "linux/amd64", "linux/arm/v6", "linux/arm/v7", "linux/arm64", "linux/ppc64le", "linux/s390x", "windows/amd64", "windows/arm64"]
...
target "_pkg-compose" {
  args = {
    ...
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.8" # https://github.com/docker/compose/blob/main/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
...
target "_pkg-containerd" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "release/2.4"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.27.1" # https://github.com/containerd/containerd/blob/release/2.4/.github/workflows/release/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
