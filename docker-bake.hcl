...
target "_pkg-compose" {
  args = {
    ...
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.4" # https://github.com/docker/compose/blob/main/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
...
target "_pkg-credential-helpers" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "main"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.4" # https://github.com/docker/docker-credential-helpers/blob/main/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
...
target "_pkg-docker-cli" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "master"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.4" # https://github.com/docker/cli/blob/master/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
...
target "_pkg-docker-engine" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "master"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.4" # https://github.com/moby/moby/blob/master/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : "5"
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
...
target "_pkg-agent" {
  args = {
    ...
    PKG_REF = PKG_REF != null && PKG_REF != "" ? PKG_REF : "main"
    GO_VERSION = GO_VERSION != null && GO_VERSION != "" ? GO_VERSION : "1.26.4" # https://github.com/docker/docker-agent/blob/main/Dockerfile
    GO_IMAGE_VARIANT = GO_IMAGE_VARIANT != null && GO_IMAGE_VARIANT != "" ? GO_IMAGE_VARIANT : "bookworm"
    PKG_DEB_EPOCH = PKG_DEB_EPOCH != null && PKG_DEB_EPOCH != "" ? PKG_DEB_EPOCH : ""
    PKG_REMOTE_DOCKERFILE = "Dockerfile"
  }
